...
if(isset($_POST['submit'])) {
    ...
    $hf_id = sanitize(trim($_POST['hf_id']));
    $hf_name = sanitize(trim($_POST['hf_name']));
    $hf_type = sanitize(trim($_POST['hf_type']));
    $hf_version = sanitize(trim($_POST['hf_version']));
...
//     // echo $filename;
         ...
         $sql = "INSERT INTO hf( hf_name, hf_type, hf_version,hf_photo)
 VALUES ( '$hf_name', '$hf_type', '$hf_version','$image') ";
...
<div class="container">
    ...
    <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 20px">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <p class="page-header" style="text-align: center">ADD HF SIGNAL EQUIPMENT</p>

            <div class="container">
                <form class="form-horizontal" role="form" action="addhf.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="Username" class="col-sm-2 control-label">FULL NAME</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hf_name" placeholder="Full name" id="hf_name" required>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">TYPE </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hf_type" placeholder="HF/VHF/UHF" id="hf_type" required>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">VERSION</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hf_version" placeholder="Manpack/Vehilce/Base Station" id="hf_version" required>
                        </div>      
                    </div>
