...
include "includes/header.php"; 
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "DELETE from uhf where uhf_id = '$id' ";
		$query = mysqli_query($conn, $sql);

		if ($query) {
			echo "<script>alert('UHF  Deleted!')</script>";
		}
	}
...
<div class="container">
	...
	<div class="alert alert-warning col-lg-7 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="margin-top:70px">
	    ...
	    <strong><b>UHF SIGNAL EQUIPMENT</b></strong> Table
	</div>
	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="adduhf.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add UHF Radio Set</button></a>
		  ...
		  <table class="table table-bordered">
		          ...
		          <tbody> 
		            <tr> 
		             ...
		             <td><?php echo $row['uhf_name']; ?></td>
		             <td><?php echo $row['uhf_type']; ?></td>
		             <td><?php echo $row['uhf_version']; ?></td>
		             <td><img src="<?php echo  $row['uhf_photo'] ?>" width="90" height="90" alt=""></td>
		             
		             <td>
		             	<form action="viewuhf.php" method="post">
		             	<input type="hidden" value="<?php echo $row['uhf_id']; ?>" name="del_btn">
