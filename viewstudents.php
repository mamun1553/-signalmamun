	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="addstudent.php" target="_blank"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" 
		  	  	style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign">
