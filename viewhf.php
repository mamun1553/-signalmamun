...
include "includes/header.php"; 
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "DELETE from hf where hf_id = '$id' ";
		$query = mysqli_query($conn, $sql);

		if ($query) {
			echo "<script>alert('HF  Deleted!')</script>";
		}
	}
	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="addhf.php" target="_blank"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add HF Radio Set</button></a>
		          ...
		          <tbody> 
		            <tr> 
		             ...
		             <td>
		                ...
		                <li><a href="viewbarret2090.php">ENTER</a></li>
		             </td>
		            </tr> 
