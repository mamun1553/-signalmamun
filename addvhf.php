...
if(isset($_POST['submit'])) {
    ...
    $vhf_id = sanitize(trim($_POST['vhf_id']));
    $vhf_name = sanitize(trim($_POST['vhf_name']));
    $vhf_type = sanitize(trim($_POST['vhf_type']));
    $vhf_version = sanitize(trim($_POST['vhf_version']));
...
//     // echo $filename;
         ...
         $sql = "INSERT INTO vhf( vhf_name, vhf_type, vhf_version,vhf_photo)
 VALUES ( '$vhf_name', '$vhf_type', '$vhf_version','$image') ";
...
<div class="container">
    ...
    <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 20px">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <p class="page-header" style="text-align: center">ADD VHF SIGNAL EQUIPMENT</p>

            <div class="container">
                <form class="form-horizontal" role="form" action="addvhf.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="Username" class="col-sm-2 control-label">FULL NAME</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="vhf_name" placeholder="Full name" id="vhf_name" required>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">TYPE </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="vhf_type" placeholder="HF/VHF/UHF" id="vhf_type" required>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">VERSION</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="vhf_version" placeholder="Manpack/Vehilce/Base Station" id="vhf_version" required>
                        </div>      
                    </div>
...
<script type="text/javascript">
 	window.onload = function () {
		var input = document.getElementById('vhf_name').focus();
	}
 </script>
</body>
</html>