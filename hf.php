...
if (isset($_FILES['postimg'])) {
    ...
    // echo $filename;
         ...
         $sql = "INSERT INTO hf( hf_name, hf_type, hf_version)
 VALUES ( '$hf_name', '$hf_type', '$hf_version') ";
...
<div class="container">
    ...
    <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  " style="margin-top: 20px">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="hf.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hf_type" placeholder="Manpack/Vehilce/Base Station" id="hf_type" required>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">VERSION</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hf_version" placeholder="unit" id="hf_version" required>
                        </div>      
                    </div>
