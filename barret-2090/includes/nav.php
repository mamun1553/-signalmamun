...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Signal Equipment Simulator</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example">
            <ul class="nav navbar-nav">
               ...
               <!--  <li><a href="bookstable.php">Books</a></li> --> 
                ...
                <li><a href="viewstudents.php">Operator</a></li>
                <li><a href="viewhf.php">HF Radio</a></li>
                <li><a href="viewvhf.php">VHF Radio</a></li>
                <li><a href="viewuhf.php">UHF Radio</a></li>
                <li><a href="fines.php">Radio Relay</a></li>
                <?php } ?>
